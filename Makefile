...
LDLIBS  := -lfs_stub -lsysmodule_stub -lsysutil_game_stub -lsysutil_stub \
           ...
           -lusbd_stub -lc -lnet_stub -lnetctl_stub -llv2_stub
...
SRCS    := core/main.c core/debug.c core/diag_log.c core/game_state.c core/scene_track.c core/enso_override.c core/custom_song_launcher.c core/qr_encode.c core/title_render.c core/title_cache.c core/title_prerender.c core/libc_stubs.c core/patch_ui.c core/patch_warn.c core/write_probe.c core/rsx_init.c core/overlay.c eboot_fpt.c \
           ...
           network/mgmt_poll.c network/plugin_update.c \
           network/pairing.c network/remote_control.c
OBJS    := $(SRCS:.c=.o)
