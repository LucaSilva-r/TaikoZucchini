...
/* One external HID source per drum/controller owned by a custom USB driver. */
#define KB_EXTERNAL_SOURCES 2
...
void kb_input_submit_hid_report(int source, const uint8_t report[8]);
void kb_input_clear_hid_source(int source);
